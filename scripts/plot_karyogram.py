...
parser.add_argument('--pop_order', default='beds/pop_order.txt',
                  help='file containing comma-separated list of population labels in the order of rfmix populations (1 first, 2 second, and so on). Used in bed files and karyogram labels')
...
with open(args.pop_order) as Pop_order:
    pop_order = Pop_order.readline().strip().split(",")
